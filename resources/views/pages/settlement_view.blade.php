            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-12 col-sm-12">
                    <div class="white-box" style="text-align: center">
                        ...
                        @if(count($date)>1)
                        <span style="caption-side: top; font-weight: bolder; font-size: 2rem; text-transform: uppercase;">SETTLEMENTS REPORT SUMMARY BETWEEN {{ $date[0]->toFormattedDateString() }} and {{ $date[1]->toFormattedDateString() }}</span>
                        @else 
                        <span style="caption-side: top; font-weight: bolder; font-size: 2rem; ">SETTLEMENTS REPORT SUMMARY  FOR {{ $date[0]->toFormattedDateString() }}</span>
                        @endif
