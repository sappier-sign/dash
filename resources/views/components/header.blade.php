...
<nav class="navbar navbar-default navbar-static-top" style="margin-bottom: 0">
    <div class="navbar-header"><a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)"
        ...
        <div class="top-left-part"><a class="logo" href="{{url('/')}}"><i><img style="width:20%;"
                                                                             src="{{asset('img/theteller-logo-Head-small.png')}}"></i>&nbsp;<span
                        class="hidden-xs"><img style="width:40%;" src="{{asset('img/theteller-logo-text-small.png')}}"></span></a>
        </div>
