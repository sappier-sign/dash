            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-12 col-sm-12">
                    <div class="white-box" style="text-align: center">
                        ...
                        <?php if(count($date)>1): ?>
                        <span style="caption-side: top; font-weight: bolder; font-size: 2rem; text-transform: uppercase;">SETTLEMENTS REPORT SUMMARY BETWEEN <?php echo e($date[0]->toFormattedDateString()); ?> and <?php echo e($date[1]->toFormattedDateString()); ?></span>
                        <?php else: ?> 
                        <span style="caption-side: top; font-weight: bolder; font-size: 2rem; ">SETTLEMENTS REPORT SUMMARY  FOR <?php echo e($date[0]->toFormattedDateString()); ?></span>
                        <?php endif; ?>
