            ...
            <div class="row">
                <div class="center p-20 col-md-2 pull-right">
                    ...
                    <span class="hide-menu ">
                                            <a href="<?php echo e(url($download_link)); ?>" target="_blank"
                        ...
                        <div class="row row-in">
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <div class="">
                                    ...
                                    <h5>
                                        <b>Date:</b> <?php echo e(\Carbon\Carbon::parse($start)->toFormattedDateString()); ?> - <?php echo e(\Carbon\Carbon::parse($end)->toFormattedDateString()); ?></h5>
                                </div>
                            </div>
                        </div>
